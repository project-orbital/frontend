    ...
    return (
        <SimpleGrid spacing={8} minChildWidth={60}>
            <BlogPostCard
                ...
                Link="www.forbes.com/sites/jimwang/2019/10/09/6-crucial-money-tips-for-college-students/?sh=5f1f04b33aaf"
                Picture={CollegeStudent}
            />
            <BlogPostCard
                Header="For young adults"
                Summary="8 essential budgeting tips on how to spend less and save more. "
                Link="smartwealth.sg/50-30-20-budget-rule/"
                Picture={YoungAdult}
            />
            <BlogPostCard
            ...
            <BlogPostCard
                ...
                Link="www.investopedia.com/guide-allowances-and-kids-5217591"
                Picture={Parents}
            />
        </SimpleGrid>
    );
