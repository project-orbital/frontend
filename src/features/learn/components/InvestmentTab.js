    ...
    return (
        <SimpleGrid minChildWidth={60} spacing={8}>
            <BlogPostCard
                ...
                Link="www.strawberryinvest.com/knowledge-hub/top-10-tips-for-first-time-investors/"
                Picture={newbie}
            />
            <BlogPostCard
                Header="From Warren Buffett"
                Summary="Let's hear from one of the most successful investors in the world. "
                Link="www.simplysafedividends.com/intelligent-income/posts/37-top-10-pieces-of-investment-advice-from-warren-buffett"
            ...
            <BlogPostCard
                ...
                Link="www.investopedia.com/articles/00/082100.asp "
                Picture={Longterm}
            />
        </SimpleGrid>
    );
